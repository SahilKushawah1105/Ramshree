...
import { MapPin, Phone, Mail, Globe, ArrowRight, FileText } from 'lucide-react'
                    ...
                    <div className="footer-col">
                        ...
                        <ul>
                            ...
                            {settings.catalog_url && (
                                <li>
                                    <a href={getApiUrl(settings.catalog_url)} target="_blank" rel="noopener noreferrer" className="catalog-link">
                                        <FileText size={14} /> Download catalogue
                                    </a>
                                </li>
                            )}
                        </ul>
